...
if (isset($_POST['reg_user'])) {
  ...
  if (empty($admissionnumber)) { array_push($errors, "Roll is required"); }
  if (empty($companyname)) { array_push($errors, "Company name is required"); }
  if (empty($companyaddress)) { array_push($errors, "companyaddress is required"); }
  if (empty($companyemail)) { array_push($errors, "companyemail is required"); }
  if (empty($companycontact)) { array_push($errors, "companycontact is required"); }
  if (empty($companywebsite)) { array_push($errors, "companywebsite is required"); }
  if (empty($startingdate)) { array_push($errors, "startingdate is required"); }
