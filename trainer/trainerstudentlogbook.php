...
<body>
        ...
        <form method="post" action="trainerstudentlogbook.php">
            <div class="nav">
                ...
                <div class="form-group">
                    ...
                    <button onclick="myFunction7()" type="button" class="btn">TRAINER REMARK</button>
                </div>
                <div class="aside">
                    <hr>
                    ...
                    <textarea type="text" id="trmk" name="trainer_remarks_notes" class="form-control trmk" placeholder="TRAINER WEEKLY REMARK"></textarea>
                    ...
                    <input name="create_post7" type="submit" id="btn_save8" value="SUBMIT TRAINER REMARK" class="btn  sv9">
                    <hr>
                    <ul>
                ...
                <tbody id="show_data">
                    ...
                    if (isset($_SESSION['student_id'])) {
                        ...
                        foreach ($select_all_weeks as $key => $t) {
                            ...
                            $week_days = array('MONDAY', 'TUESDAY', 'WEDNESDAY', 'THURSDAY', 'FRIDAY', 'SATURDAY', 'REMARK', 'TRAINERREMARK');
                            $classes = array();
    ...
    if (isset($_POST['create_post7'])) {
        ...
        // $day_title = isset($_GET['mon_days']) ? $_GET['mon_days'] : '';
        // $day_title = isset($_POST['mon_days']) ? $_POST['mon_days'] : '';
        $day_title = $_POST['trainerremark'];
        $week_title = $_POST['week_id'];
        $day_notes  = $_POST['trainer_remarks_notes'];
        $student_id = $_SESSION['student_id'];
        $query = "UPDATE  logbookdata SET trainercomment = '{$day_notes}' WHERE week_id = '{$week_title}'";
...
<script>
    ...
    function myFunction7() {
        ...
        var j = document.getElementById("sat");
        var k = document.getElementById("remark");
        var m = document.getElementById("trainerremark");
        var g = document.getElementById("wed");
        var f = document.getElementById("tue");
        var r = document.getElementById("rmk");
